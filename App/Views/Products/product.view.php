...
<div class="container mt-5">
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="?c=products&a=prosecco">Prosecco</a></li>
            <li class="breadcrumb-item active" aria-current="page">Conca d'oro - Conegliano Valdobbiadene Prosecco Superiore DOCG Extra Dry</li>
        </ol>
    </nav>
    <div class="row ">
        ...
        <div class="col-lg-6 border border-1">
            <h1 class="fw-bold">
                Conca d'oro - Conegliano Valdobbiadene Prosecco Superiore DOCG Extra Dry
            </h1>

            <p class="my-4" style="font-size: small"><h6 style="flood-color: silver">
                Popis
            </h6>
            Víno je vynikajúcou vzorkou prosecco superiore. Hrozno zreje na kopcoch Conegliano a Valdobbiadene – jedinečné miesto s priaznivým podnebím, ovplyvnené horami a morom. Toto všetko prispievaja k tvorbe intenzívne aromatického prosecca.</p>
            <span class="fw-bold text-primary" style="font-size: xx-large">€13.50  </span><span>  / ks</span>
            <div class="mt-2">
