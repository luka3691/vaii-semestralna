...
/** @var \App\Core\IValidityChecker $cartManipulator */
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex justify-content-center">
                ...
                <form  method="post" action="<?= "?c=products&a=search" ?>">
                    <div class="row">
                        <div class="col-9">
                        ...
                        <div class="col-3">
                            <button class="btn button-style" type="submit" name="submitsearch">
                ...
                <!--
                onclick="window.location.href='?c=products&a=search';"
                <div class="row">
                    <div class="col-9">
                        <input class="form-control " name="search" type="search" placeholder="Vyhľadať v obchode..." aria-label="Search" value="<?=$validator->getParam("search")?>">
                    </div>
